...
pub static mut kBitMask_120: std::cell::LazyCell<[i32; 17]> = std::cell::LazyCell::new(|| unsafe {
    [
...
impl brunsli_BitSource {
    ...
    pub unsafe fn Init(&mut self, mut in_: *mut brunsli_WordSource) {
        self.val_ = ((unsafe { brunsli_WordSource::GetNextWord(&mut (*in_)) }) as u32);
        self.bit_pos_ = 0;
    }
    pub unsafe fn ReadBits(&mut self, mut nbits: i32, mut in_: *mut brunsli_WordSource) -> u32 {
        ...
        let mut result: u32 = (((self.val_) >> (self.bit_pos_))
            & ((*std::cell::LazyCell::force_mut(&mut *&raw mut kBitMask_120))[(nbits) as usize]
                as u32));
        self.bit_pos_ += nbits;
        if ((self.bit_pos_) > (16)) {
            self.bit_pos_ -= 16;
    ...
    pub unsafe fn Finish(&mut self) -> bool {
        ...
        if ((n_bits) > (0_usize)) {
            let mut padding_bits: i32 = ((((self.val_) >> (self.bit_pos_))
                & ((*std::cell::LazyCell::force_mut(&mut *&raw mut kBitMask_120))[(n_bits)] as u32))
                as i32);
            if ((padding_bits) != (0)) {
                return false;
            }
...
impl brunsli_ANSDecoder {
    ...
    pub unsafe fn Init(&mut self, mut in_: *mut brunsli_WordSource) {
        self.state_ = ((unsafe { brunsli_WordSource::GetNextWord(&mut (*in_)) }) as u32);
    ...
    pub unsafe fn ReadSymbol(
        ...
        let res: u32 = ((self.state_)
            & (((*std::cell::LazyCell::force_mut(&mut *&raw mut BRUNSLI_ANS_TAB_SIZE_1)) - (1))
                as u32));
        let s: *const brunsli_ANSSymbolInfo = &(*code).map_[(res) as usize];
        self.state_ = (((*s).freq_ as u32).wrapping_mul(
            ((self.state_)
...
impl brunsli_BinaryArithmeticDecoder {
    ...
    pub unsafe fn Init(&mut self, mut in_: *mut brunsli_WordSource) {
        self.low_ = 0_u32;
        self.high_ = !0_u32;
        self.value_ = ((unsafe { brunsli_WordSource::GetNextWord(&mut (*in_)) }) as u32);
...
impl brunsli_internal_dec_OutputChunk {
    ...
    pub unsafe fn operator_assign_pmutbrunsli_internal_dec_OutputChunk_rv(
        ...
        self.next = (*_a0).next;
        self.len = (*_a0).len;
        self.buffer = (*_a0).buffer.take();
        return &mut (*(self as *mut brunsli_internal_dec_OutputChunk));
    }
}
...
impl brunsli_internal_dec_BitWriter {
    ...
    pub unsafe fn operator_assign_pmutbrunsli_internal_dec_BitWriter_rv(
        ...
        self.data = (*_a0).data;
        self.pos = (*_a0).pos;
        self.put_buffer = (*_a0).put_buffer;
        self.put_bits = (*_a0).put_bits;
        return &mut (*(self as *mut brunsli_internal_dec_BitWriter));
    }
}
#[repr(C)]
...
impl brunsli_internal_dec_EncodeScanState {
    pub unsafe fn EncodeScanState_pmutbrunsli_internal_dec_EncodeScanState_rv(
        ...
        let mut this = Self {
            ...
            block_scan_index: (*_a0).block_scan_index,
            coding_state: (*_a0).coding_state.clone(),
            extra_zero_runs_pos: (*_a0).extra_zero_runs_pos,
            next_extra_zero_run_index: (*_a0).next_extra_zero_run_index,
            next_reset_point_pos: (*_a0).next_reset_point_pos,
            next_reset_point: (*_a0).next_reset_point,
        };
        this
    }
    pub unsafe fn operator_assign_pmutbrunsli_internal_dec_EncodeScanState_rv(
        ...
        self.block_scan_index = (*_a0).block_scan_index;
        self.coding_state = ((*_a0).coding_state).clone();
        self.extra_zero_runs_pos = (*_a0).extra_zero_runs_pos;
        self.next_extra_zero_run_index = (*_a0).next_extra_zero_run_index;
        self.next_reset_point_pos = (*_a0).next_reset_point_pos;
        self.next_reset_point = (*_a0).next_reset_point;
        return &mut (*(self as *mut brunsli_internal_dec_EncodeScanState));
    }
}
...
impl brunsli_internal_dec_SerializationState {
    ...
    pub unsafe fn operator_assign_pmutbrunsli_internal_dec_SerializationState_rv(
        ...
        self.stage = (*_a0).stage;
        self.output_queue = std::mem::take(&mut (*_a0).output_queue);
        self.section_index = (*_a0).section_index;
        self.dht_index = (*_a0).dht_index;
        self.dqt_index = (*_a0).dqt_index;
        self.app_index = (*_a0).app_index;
        self.com_index = (*_a0).com_index;
        self.data_index = (*_a0).data_index;
        self.scan_index = (*_a0).scan_index;
        self.dc_huff_table = std::mem::take(&mut (*_a0).dc_huff_table);
        self.ac_huff_table = std::mem::take(&mut (*_a0).ac_huff_table);
        self.pad_bits = (*_a0).pad_bits;
        self.pad_bits_end = (*_a0).pad_bits_end;
        self.seen_dri_marker = (*_a0).seen_dri_marker;
...
impl brunsli_internal_dec_HistogramDataState {
    pub unsafe fn HistogramDataState_pmutbrunsli_internal_dec_HistogramDataState_rv(
        ...
        let mut this = Self {
            stage: (*_a0).stage,
            br: (*_a0).br.clone(),
            max_run_length_prefix: (*_a0).max_run_length_prefix,
    ...
    pub unsafe fn operator_assign_pmutbrunsli_internal_dec_HistogramDataState_rv(
        ...
        self.stage = (*_a0).stage;
        self.br = ((*_a0).br).clone();
        self.max_run_length_prefix = (*_a0).max_run_length_prefix;
        self.entropy = (*_a0).entropy.take();
        self.i = (*_a0).i;
...
impl brunsli_internal_dec_InternalState {
    ...
    pub unsafe fn operator_assign_pmutbrunsli_internal_dec_InternalState_rv(
        ...
        self.ac_dc = ((*_a0).ac_dc).clone();
        self.section = (*_a0).section;
        ...
        self.block_state_ = std::mem::take(&mut (*_a0).block_state_);
        self.is_meta_warm = (*_a0).is_meta_warm;
        self.shallow_histograms = (*_a0).shallow_histograms;
        self.num_contexts = (*_a0).num_contexts;
        self.num_histograms = (*_a0).num_histograms;
        self.subdecoders_initialized = (*_a0).subdecoders_initialized;
        self.ans_decoder = ((*_a0).ans_decoder).clone();
        self.bit_reader = ((*_a0).bit_reader).clone();
        self.arith_decoder = (*_a0).arith_decoder;
        self.result = (*_a0).result;
        self.last_stage = (*_a0).last_stage;
...
pub static mut kNumDirectCodes_135: std::cell::LazyCell<i32> =
    std::cell::LazyCell::new(|| unsafe { 8 });
pub static mut kCoeffAlphabetSize_136: std::cell::LazyCell<i32> =
    std::cell::LazyCell::new(|| unsafe {
        ((*std::cell::LazyCell::force_mut(&mut *&raw mut kNumDirectCodes_135)) + (10))
    });
pub static mut kKnownSectionTags_137: std::cell::LazyCell<u32> =
    std::cell::LazyCell::new(|| unsafe {
        ((((((((((1_u32)
            << ((*std::cell::LazyCell::force_mut(&mut *&raw mut kBrunsliSignatureTag_30))
                as i32))
            ...
            | ((1_u32)
                << ((*std::cell::LazyCell::force_mut(&mut *&raw mut kBrunsliHistogramDataTag_35))
                    as i32)))
            | ((1_u32)
                << ((*std::cell::LazyCell::force_mut(&mut *&raw mut kBrunsliDCDataTag_36))
                    as i32)))
            | ((1_u32)
                << ((*std::cell::LazyCell::force_mut(&mut *&raw mut kBrunsliACDataTag_37))
                    as i32)))
            | ((1_u32)
                << ((*std::cell::LazyCell::force_mut(&mut *&raw mut kBrunsliOriginalJpgTag_38))
                    as i32)))
    });
pub static mut kKnownHeaderVarintTags_138: std::cell::LazyCell<u32> =
    std::cell::LazyCell::new(|| unsafe {
        (((((1_u32)
            << ((*std::cell::LazyCell::force_mut(&mut *&raw mut kBrunsliHeaderWidthTag_39))
                as i32))
            | ((1_u32)
                << ((*std::cell::LazyCell::force_mut(&mut *&raw mut kBrunsliHeaderHeightTag_40))
                    as i32)))
            | ((1_u32)
                << ((*std::cell::LazyCell::force_mut(
                    &mut *&raw mut kBrunsliHeaderVersionCompTag_41,
                )) as i32)))
            | ((1_u32)
                << ((*std::cell::LazyCell::force_mut(
                    &mut *&raw mut kBrunsliHeaderSubsamplingTag_42,
                )) as i32)))
    });
...
pub unsafe fn DecodeVarint_144(
    ...
    if (((*s).stage as i32) == (brunsli_internal_dec_VarintState_Stage_INIT as i32)) {
        (*s).value = 0_usize;
        (*s).i = 0_usize;
        (*s).stage = brunsli_internal_dec_VarintState_Stage_READ_CONTINUATION;
    }
    'loop_: while true {
        'switch: {
            ...
            match __match_cond {
                __v if __v == (brunsli_internal_dec_VarintState_Stage_READ_CONTINUATION as i32) => {
                    ...
                    (*s).stage = brunsli_internal_dec_VarintState_Stage_READ_DATA;
                    continue 'loop_;
                }
...
pub unsafe fn GenerateApp0Marker_147(mut app0_status: u8) -> Vec<u8> {
    let mut app0_marker: Vec<u8> = core::slice::from_raw_parts(
        ...
        ((*std::cell::LazyCell::force_mut(&mut *&raw mut AppData_0xe0_62))
            .as_ptr()
            .offset((17) as isize))
        .offset_from((*std::cell::LazyCell::force_mut(&mut *&raw mut AppData_0xe0_62)).as_ptr())
            as usize,
    )
    .to_vec();
    ...
    let mut x_dens: u16 =
        (*std::cell::LazyCell::force_mut(&mut *&raw mut kApp0Densities_46))[(app0_status) as usize];
...
pub unsafe fn GenerateAppMarker_148(mut marker: u8, mut code: u8) -> Vec<u8> {
    ...
    if ((marker as i32) == (128)) {
        s = core::slice::from_raw_parts(
            ...
            .offset_from((*std::cell::LazyCell::force_mut(&mut *&raw mut AppData_0xe2_63)).as_ptr())
                as usize,
        )
        .to_vec();
        s[(84_usize)] = code;
        ...
        s = core::slice::from_raw_parts(
            ...
            ((*std::cell::LazyCell::force_mut(&mut *&raw mut AppData_0xec_64))
                .as_ptr()
                .offset((18) as isize))
            .offset_from((*std::cell::LazyCell::force_mut(&mut *&raw mut AppData_0xec_64)).as_ptr())
                as usize,
        )
        .to_vec();
        s[(15_usize)] = code;
        ...
        s = core::slice::from_raw_parts(
            ...
            ((*std::cell::LazyCell::force_mut(&mut *&raw mut AppData_0xee_65))
                .as_ptr()
                .offset((15) as isize))
            .offset_from((*std::cell::LazyCell::force_mut(&mut *&raw mut AppData_0xee_65)).as_ptr())
                as usize,
        )
        .to_vec();
        s[(10_usize)] = code;
            ...
            match __match_cond {
                __v if __v == (brunsli_internal_dec_MetadataState_Stage_READ_MARKER as usize) => {
                    ...
                    if (((*state).marker as i32) == (217)) {
                        ...
                        if (((*state).short_marker_count)
                            > ((*std::cell::LazyCell::force_mut(
                                &mut *&raw mut kBrunsliShortMarkerLimit_23,
                            )) as usize))
                        {
                            return false;
                        }
                    ...
                    == (brunsli_internal_dec_MetadataState_Stage_READ_LENGTH_LO as usize) =>
                {
                    ...
                    if ((((*(dest).cast_const()).len() as u64).wrapping_sub((delta as u64)))
                        >= ((*std::cell::LazyCell::force_mut(
                            &mut *&raw mut kBrunsliMultibyteMarkerLimit_24,
                        )) as u64))
                    {
                        return false;
                    }
            ...
            match __match_cond {
                        ...
                        as i32) =>
                {
                    ...
                    if (found_match != 0) {
                        ...
                        (*js).stage = brunsli_internal_dec_JpegInternalsState_Stage_HUFFMAN_UPDATE;
                    } else {
                        (unsafe {
                            let _values: Vec<u8> = if (*js).is_dc_table {
                                core::slice::from_raw_parts(
                                    (*std::cell::LazyCell::force_mut(
                                        &mut *&raw mut kDefaultDCValues_60,
                                    ))
                                    .as_ptr(),
                                    ((*std::cell::LazyCell::force_mut(
                                        &mut *&raw mut kDefaultDCValues_60,
                                ...
                                core::slice::from_raw_parts(
                                    (*std::cell::LazyCell::force_mut(
                                        &mut *&raw mut kDefaultACValues_61,
                                    ))
                                    .as_ptr(),
                                    ((*std::cell::LazyCell::force_mut(
                                        &mut *&raw mut kDefaultACValues_61,
                        ...
                        as i32) =>
                {
                    ...
                    (*js).i = 1_usize;
                    (*js).stage = brunsli_internal_dec_JpegInternalsState_Stage_READ_HUFFMAN_COUNT;
                    continue 'loop_;
                }
                __v if __v
                        ...
                        as i32) =>
                {
                    let mut huff: *mut brunsli_JPEGHuffmanCode =
                        (((*jpg).huffman_code).last_mut().unwrap());
                    if (((*js).i) <= ((*js).max_len)) {
                        let mut shift: usize = ((*std::cell::LazyCell::force_mut(
                            &mut *&raw mut kJpegHuffmanMaxBitLength_7,
                        )) as usize)
                            .wrapping_sub((*js).i);
                        ...
                        as i32) =>
                {
                    ...
                    (&mut (*huff)).values[((*js).total_count)] = (*std::cell::LazyCell::force_mut(
                        &mut *&raw mut kJpegHuffmanAlphabetSize_8,
                    ));
                    (*js).stage = brunsli_internal_dec_JpegInternalsState_Stage_HUFFMAN_UPDATE;
                    continue 'loop_;
                }
                    ...
                    == (brunsli_internal_dec_JpegInternalsState_Stage_HUFFMAN_UPDATE as i32) =>
                {
                    ...
                    if (((*jpg).huffman_code.len())
                        >= ((*std::cell::LazyCell::force_mut(&mut *&raw mut kMaxDHTMarkers_10))
                            as usize))
                    {
                        return brunsli_BrunsliStatus_BRUNSLI_INVALID_BRN;
                    }
                    (*js).stage = brunsli_internal_dec_JpegInternalsState_Stage_READ_HUFFMAN_LAST;
                    continue 'loop_;
                }
                _ => {
...
pub unsafe fn DecodeScanInfo_151(
 ...
 ( * js ) . j   = 0_usize  ;
 ( * js ) . stage   = brunsli_internal_dec_JpegInternalsState_Stage_READ_SCAN_COMPONENT  ;
 ;
 continue 'loop_ ;
 ...
 } if ( ( unsafe { BrunsliBitReaderRead_126 ( br , 1_u32 , ) } )  != 0 ) { ( * js ) . stage   = brunsli_internal_dec_JpegInternalsState_Stage_READ_SCAN_RESET_POINT_DATA  ;
 } else { ( * js ) . last_block_idx   = 0  ;
 ( * js ) . last_num   = 0  ;
 ( * js ) . stage   = brunsli_internal_dec_JpegInternalsState_Stage_READ_SCAN_ZERO_RUN_CONTINUATION  ;
 } ;
 continue 'loop_ ;
...
pub unsafe fn DecodeCoeffOrder_152(
    ...
    'loop_: while ((i) < (*std::cell::LazyCell::force_mut(&mut *&raw mut kDCTBlockSize_3))) {
        if !((unsafe { brunsli_BitSource::ReadBits(&mut (*br), 1, in_) }) != 0) {
            i += (*std::cell::LazyCell::force_mut(&mut *&raw mut kSpan_153));
            continue 'loop_;
        }
        let start: i32 = if ((i) > (0)) { i } else { 1 };
        let end: i32 = ((i) + (*std::cell::LazyCell::force_mut(&mut *&raw mut kSpan_153)));
        let mut j: i32 = start;
        'loop_: while ((j) < (end)) {
            let mut v: u32 = 0_u32;
            'loop_: while ((v)
            ...
            if ((v) > ((*std::cell::LazyCell::force_mut(&mut *&raw mut kDCTBlockSize_3)) as u32)) {
                return false;
            }
            lehmer[(j) as usize] = v;
            j.prefix_inc();
    ...
    let mut end: i32 = ((*std::cell::LazyCell::force_mut(&mut *&raw mut kDCTBlockSize_3)) - (1));
    ...
    'loop_: while ((k) < (*std::cell::LazyCell::force_mut(&mut *&raw mut kDCTBlockSize_3))) {
        (*order.offset((k) as isize)) =
            (*std::cell::LazyCell::force_mut(&mut *&raw mut kJPEGNaturalOrder_13))
                [(*order.offset((k) as isize)) as usize];
        k.prefix_inc();
    }
    return true;
}
pub unsafe fn DecodeNumNonzeros_154(
    ...
    'loop_: while ((b) < (*std::cell::LazyCell::force_mut(&mut *&raw mut kNumNonZeroBits_84))) {
        let bit: i32 = (unsafe {
    ...
    let mut val: usize = (ctx).wrapping_sub(
        (((1_u32) << (*std::cell::LazyCell::force_mut(&mut *&raw mut kNumNonZeroBits_84)))
            as usize),
    );
    if !((val) <= (*std::cell::LazyCell::force_mut(&mut *&raw mut kNumNonZeroTreeSize_85))) {
        (unsafe {
            BrunsliDumpAndAbort_79(
                c"brunsli_decode.cc".as_ptr(),
                593,
...
pub unsafe fn DecodeDC_157(
    ...
    let meta: *const Vec<brunsli_internal_dec_ComponentMeta> = &(*state).meta;
    let num_components: usize = (*meta).len();
    let mcu_rows: i32 = (((&(*meta))[(0_usize)].height_in_blocks) / ((&(*meta))[(0_usize)].v_samp));
    let s: *mut brunsli_internal_dec_InternalState =
        &mut (*(*state).internal.as_deref_mut().unwrap());
    let ac_dc_state: *mut brunsli_internal_dec_AcDcState = &mut (*s).ac_dc;
    let comps: *mut Vec<brunsli_ComponentStateDC> = &mut (*ac_dc_state).dc;
    if (*comps).is_empty() {
        {
    ...
    'loop_: while ((mcu_y) < (mcu_rows)) {
        ...
        'loop_: while ((i) < (num_components)) {
            ...
            let m: *const brunsli_internal_dec_ComponentMeta = &(&(*meta))[(i)];
            let mut context_map: *const u8 = (*state).context_map.offset(
                ((i).wrapping_mul(
            ...
            'loop_: while ((iy) < ((*m).v_samp)) {
                let mut coeffs: *mut i16 =
                    (*m).ac_coeffs.offset(((y) * (ac_stride)) as isize).offset(
                        (((*ac_dc_state).next_x)
                            * (*std::cell::LazyCell::force_mut(&mut *&raw mut kDCTBlockSize_3)))
                            as isize,
                    );
                ...
                'loop_: while ((x) < (width)) {
                    ...
                    (&mut (*c)).prev_is_nonempty[(((x) + (1)) as usize)] =
                    ...
                    if !(is_empty_block) {
                        ...
                        if !(is_zero != 0) {
                            ...
                            if ((code)
                                < (*std::cell::LazyCell::force_mut(
                                    &mut *&raw mut kNumDirectCodes_135,
                                )))
                            {
                                abs_val = ((code) + (1));
                            } else {
                                let mut nbits: i32 = ((code)
                                    - (*std::cell::LazyCell::force_mut(
                                        &mut *&raw mut kNumDirectCodes_135,
                                    )));
                                ...
                                abs_val = ((((*std::cell::LazyCell::force_mut(
                                    &mut *&raw mut kNumDirectCodes_135,
                                )) - (1))
                                    + ((2) << (nbits)))
                                    + (extra_bits_val));
    ...
    'loop_: while ((k) > (0_usize)) {
        ...
        if ((k) < (last_nz)) {
            let mut bucket: usize =
                ((*std::cell::LazyCell::force_mut(&mut *&raw mut kNonzeroBuckets_89))
                    [((num_nonzeros).wrapping_sub(1_usize))] as usize);
            let mut is_zero_ctx: usize = ((bucket).wrapping_mul(
                ((*std::cell::LazyCell::force_mut(&mut *&raw mut kDCTBlockSize_3)) as usize),
            ))
            .wrapping_add(k);
            let p: *mut brunsli_Prob = &mut (*c.is_zero_prob.offset((is_zero_ctx) as isize));
            is_zero = (unsafe {
                brunsli_BinaryArithmeticDecoder::ReadBit(
                    &mut ac,
        ...
        if !(is_zero != 0) {
            ...
            .wrapping_add(k);
            let sign_p: *mut brunsli_Prob = &mut (*c.sign_prob.offset((sign_ctx) as isize));
            sign = (unsafe {
                brunsli_BinaryArithmeticDecoder::ReadBit(
                    &mut ac,
            ...
            let mut histo_ix: usize = ((z_dens_ctx).wrapping_mul(
                (*std::cell::LazyCell::force_mut(&mut *&raw mut kNumAvrgContexts_83)),
            ))
            .wrapping_add(avg_ctx);
            ...
            if ((code) < (*std::cell::LazyCell::force_mut(&mut *&raw mut kNumDirectCodes_135))) {
                ...
                let mut nbits: i32 = ((code)
                    - (*std::cell::LazyCell::force_mut(&mut *&raw mut kNumDirectCodes_135)));
                let p: *mut brunsli_Prob = &mut (*c.first_extra_bit_prob.offset(
                    (((k).wrapping_mul(10_usize)).wrapping_add((nbits as usize))) as isize,
                ));
                let mut first_extra_bit: i32 = (unsafe {
                    brunsli_BinaryArithmeticDecoder::ReadBit(
                        &mut ac,
...
pub unsafe fn DecodeAC_160(
    ...
    let s: *mut brunsli_internal_dec_InternalState =
        &mut (*(*state).internal.as_deref_mut().unwrap());
    let ac_dc_state: *mut brunsli_internal_dec_AcDcState = &mut (*s).ac_dc;
    let comps: *mut Vec<brunsli_ComponentState> = &mut (*ac_dc_state).ac;
    if (*comps).is_empty() {
        {
            let __a0 = num_components as usize;
    ...
    c.context_modes = (*std::cell::LazyCell::force_mut(&mut *&raw mut kContextAlgorithm_95))
        .as_ptr()
        .offset(
    ...
    'loop_: while ((mcu_y) < (mcu_rows)) {
        let mut i: usize = (*ac_dc_state).next_component;
        'loop_: while ((i) < (num_components)) {
            let cst: *mut brunsli_ComponentState = &mut (&mut (*comps))[(i)];
            ...
            let m: *const brunsli_internal_dec_ComponentMeta = &(&(*meta))[(i)];
            c.context_map = (*state).context_map.offset(
                (((*m).context_offset).wrapping_mul(
                    (*std::cell::LazyCell::force_mut(&mut *&raw mut kNumAvrgContexts_83)),
                )) as isize,
            );
            ...
            'loop_: while ((iy) < ((*m).v_samp)) {
                ...
                c.prev_col_coeffs = (c.coeffs.offset(
                    -((*std::cell::LazyCell::force_mut(&mut *&raw mut kDCTBlockSize_3)) as isize),
                ))
                .cast_const();
                ...
                .cast_const();
                c.prev_sgn = (&mut (&mut (*cst)).prev_sign
                    [((*std::cell::LazyCell::force_mut(&mut *&raw mut kDCTBlockSize_3)) as usize)]
                    as *mut i32)
                    .offset((block_offset) as isize);
                ...
                'loop_: while ((c.x) < (width)) {
                    ...
                    if !(is_empty) {
                        ...
                        let mut num_nonzeros: usize = (unsafe { DecodeAcBlock_159(&c) });
                        if !((num_nonzeros)
                            <= (*std::cell::LazyCell::force_mut(
                                &mut *&raw mut kNumNonZeroTreeSize_85,
                            )))
                    ...
                    c.coeffs = (c.coeffs).wrapping_add(
                        (*std::cell::LazyCell::force_mut(&mut *&raw mut kDCTBlockSize_3)) as usize,
                    );
                    c.prev_sgn = (c.prev_sgn).wrapping_add(
                        (*std::cell::LazyCell::force_mut(&mut *&raw mut kDCTBlockSize_3)) as usize,
                    );
                    c.prev_abs = (c.prev_abs).wrapping_add(
                        (*std::cell::LazyCell::force_mut(&mut *&raw mut kDCTBlockSize_3)) as usize,
                    );
                    c.prev_row_coeffs = (c.prev_row_coeffs).wrapping_add(
                        (*std::cell::LazyCell::force_mut(&mut *&raw mut kDCTBlockSize_3)) as usize,
                    );
                    c.prev_col_coeffs = (c.prev_col_coeffs).wrapping_add(
                        (*std::cell::LazyCell::force_mut(&mut *&raw mut kDCTBlockSize_3)) as usize,
                    );
                    c.x.prefix_inc();
                }
...
pub unsafe fn ReadTag_170(
    ...
    if ((wiring_type)
        != ((*std::cell::LazyCell::force_mut(&mut *&raw mut kBrunsliWiringTypeVarint_25)) as usize))
        && ((wiring_type)
            != ((*std::cell::LazyCell::force_mut(
                &mut *&raw mut kBrunsliWiringTypeLengthDelimited_26,
            )) as usize))
    {
        return brunsli_BrunsliStatus_BRUNSLI_INVALID_BRN;
    }
    (*section).is_section = ((wiring_type)
        == ((*std::cell::LazyCell::force_mut(&mut *&raw mut kBrunsliWiringTypeLengthDelimited_26))
            as usize));
...
pub unsafe fn DecodeHeader_177(
        ...
        'switch: {
            ...
            match __match_cond {
                __v if __v == (brunsli_internal_dec_HeaderState_Stage_READ_TAG as usize) => {
                    ...
                    (*hs).stage = (brunsli_internal_dec_HeaderState_Stage_ENTER_SECTION as usize);
                    break 'switch;
                }
                __v if __v == (brunsli_internal_dec_HeaderState_Stage_ENTER_SECTION as usize) => {
                    ...
                    (*hs).stage = (brunsli_internal_dec_HeaderState_Stage_ITEM_READ_TAG as usize);
                    break 'switch;
                }
                __v if __v == (brunsli_internal_dec_HeaderState_Stage_ITEM_READ_TAG as usize) => {
                    if (unsafe { IsAtSectionBoundary_175(state) }) {
                        (*hs).stage = (brunsli_internal_dec_HeaderState_Stage_FINALE as usize);
                        break 'switch;
                    }
                    let mut status: brunsli_BrunsliStatus = (unsafe {
                        ReadTag_170(
                    ...
                    if (*hs).section.is_section {
                        if (((*std::cell::LazyCell::force_mut(
                            &mut *&raw mut kKnownHeaderVarintTags_138,
                        )) & (tag_bit))
                            != 0)
                        {
                    ...
                    (*hs).stage = (brunsli_internal_dec_HeaderState_Stage_ITEM_READ_VALUE as usize);
                    break 'switch;
                }
                __v if __v
                    == (brunsli_internal_dec_HeaderState_Stage_ITEM_ENTER_SECTION as usize) =>
                ...
                __v if __v == (brunsli_internal_dec_HeaderState_Stage_FINALE as usize) => {
                    ...
                    let version_and_comp_count: usize =
                        ((&mut (*hs)).varint_values[((*std::cell::LazyCell::force_mut(
                            &mut *&raw mut kBrunsliHeaderVersionCompTag_41,
                        )) as usize)] as usize);
                    ...
                    if ((version) == (1_usize)) {
                        (*jpg).width = 0;
                        (*jpg).height = 0;
                        (*hs).stage = (brunsli_internal_dec_HeaderState_Stage_DONE as usize);
                        break 'switch;
                    }
                    ...
                    (*s).section.tags_met |= ((1_u32)
                        << ((*std::cell::LazyCell::force_mut(
                            &mut *&raw mut kBrunsliOriginalJpgTag_38,
                        )) as i32));
                    let has_width: bool = ((((*hs).section.tags_met)
                        & ((1_u32)
                            << ((*std::cell::LazyCell::force_mut(
                                &mut *&raw mut kBrunsliHeaderWidthTag_39,
                            )) as i32)))
                        != 0);
                    if !(has_width) {
                        return (unsafe {
                    ...
                    let width: usize = ((&mut (*hs)).varint_values
                        [((*std::cell::LazyCell::force_mut(
                            &mut *&raw mut kBrunsliHeaderWidthTag_39,
                        )) as usize)] as usize);
                    let has_height: bool = ((((*hs).section.tags_met)
                        & ((1_u32)
                            << ((*std::cell::LazyCell::force_mut(
                                &mut *&raw mut kBrunsliHeaderHeightTag_40,
                            )) as i32)))
                        != 0);
                    if !(has_height) {
                        return (unsafe {
                    ...
                    if ((width)
                        > ((*std::cell::LazyCell::force_mut(&mut *&raw mut kMaxDimPixels_11))
                            as usize))
                        || ((height)
                            > ((*std::cell::LazyCell::force_mut(&mut *&raw mut kMaxDimPixels_11))
                                as usize))
                    ...
                    let mut subsampling_code: usize =
                        ((&mut (*hs)).varint_values[((*std::cell::LazyCell::force_mut(
                            &mut *&raw mut kBrunsliHeaderSubsamplingTag_42,
                        )) as usize)] as usize);
                    let mut i: usize = 0_usize;
                    'loop_: while ((i) < ((*jpg).components.len())) {
                        ...
                        if (((*c).v_samp_factor)
                            > (*std::cell::LazyCell::force_mut(
                                &mut *&raw mut kBrunsliMaxSampling_27,
                            )))
                        {
                            return (unsafe {
                                Fail_169(state, brunsli_BrunsliStatus_BRUNSLI_INVALID_BRN)
    ...
    return if (((*jpg).version)
        == (*std::cell::LazyCell::force_mut(&mut *&raw mut kFallbackVersion_2)))
    {
...
pub unsafe fn DecodeMetaDataSection_180(
    ...
    let s: *mut brunsli_internal_dec_InternalState =
        &mut (*(*state).internal.as_deref_mut().unwrap());
    let ms: *mut brunsli_internal_dec_MetadataState = &mut (*s).metadata;
    ...
    if (((*ms).decompression_stage) == (brunsli_internal_dec_MetadataDecompressionStage_INITIAL)) {
        ...
        if ((unsafe { RemainingSectionLength_174(state) }) == (1_usize)) {
            ...
            data[(0) as usize] = (unsafe { ReadByte_163(state) });
            let mut ok: bool =
                (unsafe {
        ...
        (*ms).decompression_stage = brunsli_internal_dec_MetadataDecompressionStage_READ_LENGTH;
    }
        ...
        == (brunsli_internal_dec_MetadataDecompressionStage_READ_LENGTH))
    {
        ...
        (*ms).decompression_stage = brunsli_internal_dec_MetadataDecompressionStage_DECOMPRESSING;
    }
    if (((*ms).decompression_stage)
...
pub unsafe fn DecodeJPEGInternalsSection_184(
    ...
    if (((*js).stage as i32) == (brunsli_internal_dec_JpegInternalsState_Stage_READ_MARKERS as i32))
    {
        ...
        (*js).stage = brunsli_internal_dec_JpegInternalsState_Stage_READ_DRI;
    }
        ...
        == (brunsli_internal_dec_JpegInternalsState_Stage_PREPARE_READ_SCANS as i32))
    {
        ...
        if (((*js).num_scans) > (0_usize)) {
            ...
            (*js).i = 0_usize;
            (*js).stage = brunsli_internal_dec_JpegInternalsState_Stage_READ_SCAN_COMMON;
        } else {
        ...
        == (brunsli_internal_dec_JpegInternalsState_Stage_READ_NUM_QUANT as i32))
    {
        ...
        (*js).i = 0_usize;
        (*js).stage = brunsli_internal_dec_JpegInternalsState_Stage_READ_QUANT;
    }
    'loop_: while (((*js).stage as i32)
        == (brunsli_internal_dec_JpegInternalsState_Stage_READ_QUANT as i32))
    {
        if (((*js).i) >= ((*jpg).quant.len())) {
            (*js).stage = brunsli_internal_dec_JpegInternalsState_Stage_READ_COMP_ID_SCHEME;
            break;
        }
        ...
        == (brunsli_internal_dec_JpegInternalsState_Stage_READ_COMP_ID_SCHEME as i32))
    {
        ...
        if ((comp_ids) == (*std::cell::LazyCell::force_mut(&mut *&raw mut kComponentIds123_49))) {
            ...
            == (*std::cell::LazyCell::force_mut(&mut *&raw mut kComponentIdsGray_50)))
        {
            (&mut (*jpg)).components[(0_usize)].id = 1;
        } else if ((comp_ids)
            == (*std::cell::LazyCell::force_mut(&mut *&raw mut kComponentIdsRGB_51)))
        {
            ...
            if !((comp_ids)
                == (*std::cell::LazyCell::force_mut(&mut *&raw mut kComponentIdsCustom_52)))
            {
                (unsafe {
                    BrunsliDumpAndAbort_79(
                        c"brunsli_decode.cc".as_ptr(),
            ...
            (*js).i = 0_usize;
            (*js).stage = brunsli_internal_dec_JpegInternalsState_Stage_READ_COMP_ID;
        }
    }
        ...
        == (brunsli_internal_dec_JpegInternalsState_Stage_READ_NUM_PADDING_BITS as i32))
    {
        ...
        if (((*js).num_padding_bits) > ((unsafe { PaddingBitsLimit_17(&(*jpg)) }) as usize)) {
            write!(
                std::fs::File::from_raw_fd(
                    std::io::stderr()
                        .as_fd()
            ...
            {
                {
                    if (((*js).i) >= ((*jpg).marker_order.len())) {
                        (*js).stage = brunsli_internal_dec_JpegInternalsState_Stage_DONE;
...
pub unsafe fn DecodeQuantDataSection_186(
    ...
    let s: *mut brunsli_internal_dec_InternalState =
        &mut (*(*state).internal.as_deref_mut().unwrap());
    let qs: *mut brunsli_internal_dec_QuantDataState = &mut (*s).quant;
    ...
    if (((*qs).stage as i32) == (brunsli_internal_dec_QuantDataState_Stage_READ_NUM_QUANT as i32)) {
        ...
        (*qs).i = 0_usize;
        (*qs).stage = brunsli_internal_dec_QuantDataState_Stage_READ_STOCK;
    }
    'loop_: while true {
            ...
            __v if __v == (brunsli_internal_dec_QuantDataState_Stage_READ_STOCK as i32) => {
                {
                    if (((*qs).i) >= ((*jpg).quant.len())) {
                        ...
                        (*qs).i = 0_usize;
                        (*qs).stage = brunsli_internal_dec_QuantDataState_Stage_READ_QUANT_IDX;
                        continue 'loop_;
                    }
                    if !(unsafe { BrunsliBitReaderCanRead_134(br, 4_usize) }) {
                        return (unsafe {
                    ...
                    if is_short {
                        ...
                        'loop_: while ((k)
                            < ((*std::cell::LazyCell::force_mut(&mut *&raw mut kDCTBlockSize_3))
                                as usize))
                        {
                            (*table.offset((k) as isize)) = ((*std::cell::LazyCell::force_mut(
                                &mut *&raw mut kStockQuantizationTables_48,
                            ))[(selector)][(short_code)][(k)]
                                as i32);
                            k.prefix_inc();
                        }
                        (*qs).stage = brunsli_internal_dec_QuantDataState_Stage_UPDATE;
                    } else {
                        (*qs).stage = brunsli_internal_dec_QuantDataState_Stage_READ_Q_FACTOR;
                    };
                    continue 'loop_;
                }
            }
            __v if __v == (brunsli_internal_dec_QuantDataState_Stage_READ_Q_FACTOR as i32) => {
                {
                    ...
                    (*qs).j = 0_usize;
                    (*qs).delta = 0;
                    (*qs).stage = brunsli_internal_dec_QuantDataState_Stage_READ_DIFF_IS_ZERO;
                    continue 'loop_;
                }
            }
            __v if __v == (brunsli_internal_dec_QuantDataState_Stage_READ_DIFF_IS_ZERO as i32) => {
                {
                    ...
                    if ((unsafe { BrunsliBitReaderRead_126(br, 1_u32) }) != 0) {
                        (*qs).stage = brunsli_internal_dec_QuantDataState_Stage_READ_DIFF_SIGN;
                    } else {
                        (*qs).stage = brunsli_internal_dec_QuantDataState_Stage_APPLY_DIFF;
                    };
                    continue 'loop_;
                }
            }
            __v if __v == (brunsli_internal_dec_QuantDataState_Stage_READ_DIFF_SIGN as i32) => {
                {
                    ...
                    (*qs).stage = brunsli_internal_dec_QuantDataState_Stage_READ_DIFF;
                    continue 'loop_;
                }
            }
        ...
        == (brunsli_internal_dec_QuantDataState_Stage_READ_QUANT_IDX as i32))
    {
        if (((*qs).i) >= ((*jpg).components.len())) {
            (*qs).stage = brunsli_internal_dec_QuantDataState_Stage_FINISH;
            continue 'loop_;
        }
        let mut c: *mut brunsli_JPEGComponent =
...
pub unsafe fn DecodeHistogramDataSection_187(
    ...
    let s: *mut brunsli_internal_dec_InternalState =
        &mut (*(*state).internal.as_deref_mut().unwrap());
    let hs: *mut brunsli_internal_dec_HistogramDataState = &mut (*s).histogram;
    ...
    if (((*hs).stage as i32) == (brunsli_internal_dec_HistogramDataState_Stage_INIT as i32)) {
        ...
        (*s).num_contexts = (*jpg).components.len();
        (*hs).stage = brunsli_internal_dec_HistogramDataState_Stage_READ_SCHEME;
    ...
    if (((*hs).stage as i32) == (brunsli_internal_dec_HistogramDataState_Stage_READ_SCHEME as i32))
    {
        ...
        'loop_: while ((i) < (num_components)) {
            ...
            (*s).num_contexts = ((*s).num_contexts).wrapping_add(
        ...
        == (brunsli_internal_dec_HistogramDataState_Stage_READ_NUM_HISTOGRAMS as i32))
    {
        ...
        if (*s).shallow_histograms {
            ...
            {
                let __a0 = ((*s).num_contexts).wrapping_mul(
                    (*std::cell::LazyCell::force_mut(&mut *&raw mut kNumAvrgContexts_83)),
                ) as usize;
            ...
            if (((*s).num_histograms) > (1_usize)) {
                (*hs).stage = brunsli_internal_dec_HistogramDataState_Stage_READ_CONTEXT_MAP_CODE;
            } else {
                (*hs).i = 0_usize;
                {
                    let __a0 =
                        ((*std::cell::LazyCell::force_mut(&mut *&raw mut kCoeffAlphabetSize_136))
                            as usize) as usize;
                    (*hs).counts.resize_with(__a0, || <u32>::default())
                };
                (*hs).stage = brunsli_internal_dec_HistogramDataState_Stage_READ_HISTOGRAMS;
            }
        }
    }
    if (((*hs).stage as i32) == (brunsli_internal_dec_HistogramDataState_Stage_SKIP_CONTENT as i32))
    {
        ...
        (*hs).stage = brunsli_internal_dec_HistogramDataState_Stage_DONE;
    }
    if (((*hs).stage as i32)
        ...
        == (brunsli_internal_dec_HistogramDataState_Stage_READ_CONTEXT_MAP as i32))
    {
        let mut status: brunsli_BrunsliStatus = (unsafe {
            let _entropy: *const brunsli_HuffmanDecodingData =
                &(*(*hs).entropy.as_deref_mut().unwrap());
        ...
        (*hs).i = 0_usize;
        {
            let __a0 = ((*std::cell::LazyCell::force_mut(&mut *&raw mut kCoeffAlphabetSize_136))
                as usize) as usize;
            (*hs).counts.resize_with(__a0, || <u32>::default())
        };
        (*hs).stage = brunsli_internal_dec_HistogramDataState_Stage_READ_HISTOGRAMS;
        ...
        'loop_: while (((*hs).i) < ((*s).num_histograms)) {
            if !(unsafe {
                BrunsliBitReaderCanRead_134(
                    ...
                    (((9)
                        + ((*std::cell::LazyCell::force_mut(
                            &mut *&raw mut kCoeffAlphabetSize_136,
                        )) * (11))) as usize),
                )
            }) {
                return (unsafe {
            ...
            if !(unsafe {
                let _counts: *const Vec<u32> = &(*hs).counts;
        ...
        'switch: {
            ...
            match __match_cond {
                __v if __v == (brunsli_internal_dec_FallbackState_Stage_READ_TAG as usize) => {
                    ...
                    (*fs).stage = (brunsli_internal_dec_FallbackState_Stage_ENTER_SECTION as usize);
                    break 'switch;
                }
                __v if __v == (brunsli_internal_dec_FallbackState_Stage_ENTER_SECTION as usize) => {
                    ...
                    if (((*jpg).original_jpg_size) == (0_usize)) {
                        ...
                        (*fs).stage = (brunsli_internal_dec_FallbackState_Stage_DONE as usize);
                        break 'switch;
                    }
                    (*fs).stage = (brunsli_internal_dec_FallbackState_Stage_READ_CONTENTS as usize);
                    break 'switch;
                }
...
pub unsafe fn ParseSection_193(
    ...
    let s: *mut brunsli_internal_dec_InternalState =
        &mut (*(*state).internal.as_deref_mut().unwrap());
    let sh: *mut brunsli_internal_dec_SectionHeaderState = &mut (*s).section_header;
            ...
            match __match_cond {
                __v if __v == (brunsli_internal_dec_SectionHeaderState_Stage_READ_TAG as usize) => {
                    ...
                    if ((status as i32) == (brunsli_BrunsliStatus_BRUNSLI_NOT_ENOUGH_DATA as i32)) {
                        if (unsafe {
                            HasSection_194(
                                (state).cast_const(),
                                ((*std::cell::LazyCell::force_mut(
                                    &mut *&raw mut kBrunsliACDataTag_37,
                                )) as u32),
                            )
                        }) {
                            return brunsli_internal_dec_Stage_DONE;
                    ...
                    let is_known_section_tag: bool =
                        (((*std::cell::LazyCell::force_mut(&mut *&raw mut kKnownSectionTags_137))
                            & (tag_bit))
                            != 0);
...
pub unsafe fn ProcessSection_195(
                    ...
                    as usize) =>
            {
                if !(unsafe {
                    HasSection_194(
                        (state).cast_const(),
                        ((*std::cell::LazyCell::force_mut(
                            &mut *&raw mut kBrunsliJPEGInternalsTag_33,
                        )) as u32),
                    )
                }) {
                    return (unsafe { Fail_169(state, brunsli_BrunsliStatus_BRUNSLI_INVALID_BRN) });
                    ...
                    as usize) =>
            {
                if !(unsafe {
                    HasSection_194(
                        (state).cast_const(),
                        ((*std::cell::LazyCell::force_mut(
                            &mut *&raw mut kBrunsliHistogramDataTag_35,
                        )) as u32),
                    )
                }) {
                    return (unsafe { Fail_169(state, brunsli_BrunsliStatus_BRUNSLI_INVALID_BRN) });
    ...
    if (((*s).section.tag)
        == ((*std::cell::LazyCell::force_mut(&mut *&raw mut kBrunsliACDataTag_37)) as usize))
    {
        return brunsli_internal_dec_Stage_DONE;
    }
    return brunsli_internal_dec_Stage_SECTION;
...
pub unsafe fn PrepareMeta_179(
    ...
    let meta: *mut Vec<brunsli_internal_dec_ComponentMeta> = &mut (*state).meta;
    {
        let __a0 = num_components as usize;
    ...
    'loop_: while ((i) < (num_components)) {
        ...
        let m: *mut brunsli_internal_dec_ComponentMeta = &mut (&mut (*meta))[(i)];
...
pub unsafe fn WarmupMeta_196(
        ...
        'loop_: while ((i) < (num_components)) {
            let mut num_blocks: usize = ((((&mut (*meta))[(i)].width_in_blocks)
                * ((&mut (*meta))[(i)].height_in_blocks))
                as usize);
            {
                let __a0 = (num_blocks).wrapping_mul(
                    ((*std::cell::LazyCell::force_mut(&mut *&raw mut kDCTBlockSize_3)) as usize),
                ) as usize;
    ...
    if !((*s).is_meta_warm) {
        ...
        let mut c: usize = 0_usize;
        'loop_: while ((c) < (num_components)) {
            let m: *mut brunsli_internal_dec_ComponentMeta = &mut (&mut (*meta))[(c)];
            let q: *const brunsli_JPEGQuantTable =
                &(&mut (*jpg)).quant[((&mut (*jpg)).components[(c)].quant_idx as usize)];
        ...
        'switch: {
            ...
            match __match_cond {
                ...
                __v if __v == brunsli_internal_dec_Stage_HEADER => {
                    (*state).stage = (unsafe { DecodeHeader_177(state, jpg) });
                    break 'switch;
                }
                __v if __v == brunsli_internal_dec_Stage_FALLBACK => {
                    (*state).stage = (unsafe { DecodeOriginalJpg_192(state, jpg) });
                    break 'switch;
                }
                __v if __v == brunsli_internal_dec_Stage_SECTION => {
                    (*state).stage = (unsafe { ParseSection_193(state) });
                    break 'switch;
                }
                __v if __v == brunsli_internal_dec_Stage_SECTION_BODY => {
                    (*state).stage = (unsafe { ProcessSection_195(state, jpg) });
                    break 'switch;
                }
...
pub unsafe fn ChargeBuffer_198(mut state: *mut brunsli_internal_dec_State) {
    let s: *mut brunsli_internal_dec_InternalState =
        &mut (*(*state).internal.as_deref_mut().unwrap());
    let b: *mut brunsli_internal_dec_Buffer = &mut (*s).buffer;
    (*b).borrowed_len = 0_usize;
    (*b).external_data = (*state).data;
    (*b).external_pos = (*state).pos;
    (*b).external_len = (*state).len;
}
pub static mut kBufferMaxReadAhead_199: std::cell::LazyCell<usize> =
    std::cell::LazyCell::new(|| unsafe { 600_usize });
pub unsafe fn LoadInput_200(mut state: *mut brunsli_internal_dec_State) {
    ...
    if !(((*b).data_len)
        <= (*std::cell::LazyCell::force_mut(&mut *&raw mut kBufferMaxReadAhead_199)))
    {
        (unsafe {
    ...
    (*b).borrowed_len = ({
        let mut __tmp_0: u64 =
            ((*std::cell::LazyCell::force_mut(&mut *&raw mut kBufferMaxReadAhead_199)) as u64);
...
pub unsafe fn ProcessJpeg_203(
    ...
    'loop_: while ((result as i32) == (brunsli_BrunsliStatus_BRUNSLI_NOT_ENOUGH_DATA as i32)) {
        if (((*state).stage) == (brunsli_internal_dec_Stage_ERROR)) {
            ...
            (*s).result = brunsli_BrunsliStatus_BRUNSLI_OK;
            (*state).stage = (*s).last_stage;
            (*s).last_stage = brunsli_internal_dec_Stage_ERROR;
        }
        ...
        result = (unsafe { DoProcessJpeg_197(state, jpg) });
        if (*s).section.is_active {
...
pub unsafe fn BrunsliEstimateDecoderPeakMemoryUsage_205(mut data: *const u8, len: usize) -> usize {
    ...
    let mut jpeg_data_size: usize = (((total_num_blocks)
        .wrapping_mul(((*std::cell::LazyCell::force_mut(&mut *&raw mut kDCTBlockSize_3)) as usize))
        as u64)
        .wrapping_mul((::std::mem::size_of::<i16>() as u64))
        as usize);
    let mut context_map_size: usize = ((((*s).num_contexts)
...
pub static mut kLengthTree_210: std::cell::LazyCell<[i8; 31]> =
    std::cell::LazyCell::new(|| unsafe {
        [
            1_i8,
            2_i8,
...
pub static mut kLogCountTree_211: std::cell::LazyCell<[i8; 21]> =
    std::cell::LazyCell::new(|| unsafe {
        [
            1_i8,
            2_i8,
    ...
    if ((simple_code) == (1)) {
        ...
        let mut real_length: usize = (unsafe {
            ReadShortHuffmanCode_212(
                br,
                (*std::cell::LazyCell::force_mut(&mut *&raw mut kLengthTree_210)).as_ptr(),
            )
        });
        ...
        'loop_: while ((i) < (real_length)) {
            log_counts[(i)] = ((unsafe {
                ReadShortHuffmanCode_212(
                    br,
                    (*std::cell::LazyCell::force_mut(&mut *&raw mut kLogCountTree_211)).as_ptr(),
                )
            }) as u32);
...
pub static mut kDefaultCodeLength_215: std::cell::LazyCell<u8> =
    std::cell::LazyCell::new(|| unsafe { 8_u8 });
pub static mut kCodeLengthRepeatCode_216: std::cell::LazyCell<u8> =
    std::cell::LazyCell::new(|| unsafe { 16_u8 });
pub unsafe fn ReadHuffmanCodeLengths_217(
    ...
    let mut prev_code_len: u8 =
        (*std::cell::LazyCell::force_mut(&mut *&raw mut kDefaultCodeLength_215));
    ...
    let mut i: i32 = 0;
    'loop_: while ((i) < (*std::cell::LazyCell::force_mut(&mut *&raw mut kCodeLengthCodes_213))) {
    ...
    'loop_: while ((symbol) < (num_symbols)) && ((space) > (0)) {
        ...
        if ((code_len as i32)
            < ((*std::cell::LazyCell::force_mut(&mut *&raw mut kCodeLengthRepeatCode_216)) as i32))
        {
            repeat = 0_usize;
            ...
            if ((code_len as i32)
                == ((*std::cell::LazyCell::force_mut(&mut *&raw mut kCodeLengthRepeatCode_216))
                    as i32))
            {
...
pub unsafe fn ReadSimpleCode_219(
    ...
    let goal_size: u32 =
        ((1_u32) << (*std::cell::LazyCell::force_mut(&mut *&raw mut kHuffmanTableBits_21)));
...
impl brunsli_HuffmanDecodingData {
    pub unsafe fn ReadFromBitStream(
        ...
        if ((alphabet_size)
            > (((1) << (*std::cell::LazyCell::force_mut(&mut *&raw mut kMaxHuffmanBits_22)))
                as usize))
        {
            return false;
        }
        ...
        if ((simple_code_or_skip) == (1_u32)) {
            {
                let __a0 = (((1_u32)
                    << (*std::cell::LazyCell::force_mut(&mut *&raw mut kHuffmanTableBits_21)))
                    as usize) as usize;
                self.table_
        ...
        'loop_: while ((i)
            ...
            && ((space) > (0))
        {
            let code_len_idx: i32 =
                ((*std::cell::LazyCell::force_mut(&mut *&raw mut kCodeLengthCodeOrder_214))[(i)]
                    as i32);
            let mut p: *const brunsli_HuffmanCode =
                (*std::cell::LazyCell::force_mut(&mut *&raw mut huff_220)).as_ptr();
            let mut v: u8 = 0_u8;
        ...
        let mut table_size: u32 = (unsafe {
            BuildHuffmanTable_218(
                ...
                ((*std::cell::LazyCell::force_mut(&mut *&raw mut kHuffmanTableBits_21)) as usize),
...
impl brunsli_HuffmanDecodingData {
    pub unsafe fn ReadSymbol(&self, mut br: *mut brunsli_BrunsliBitReader) -> u16 {
        ...
        if ((n_bits) > (*std::cell::LazyCell::force_mut(&mut *&raw mut kHuffmanTableBits_21))) {
            (unsafe {
...
pub unsafe fn ReplicateValue_222(
    ...
    'loop_: while __do_while || ((end) > (0)) {
        ...
        (*table.offset((end) as isize)) = (code).clone();
    }
}
pub unsafe fn NextTableBitSize_223(
    ...
    'loop_: while ((len) < (*std::cell::LazyCell::force_mut(&mut *&raw mut kMaxHuffmanBits_22))) {
...
pub unsafe fn BuildHuffmanTable_218(
    ...
    if ((code_lengths_size)
        > (((1_u32) << (*std::cell::LazyCell::force_mut(&mut *&raw mut kMaxHuffmanBits_22)))
            as usize))
    {
        return 0_u32;
    }
    ...
    let mut sorted: *mut u16 = sorted_storage.as_mut_ptr();
    {
        ...
        len = 1_usize;
        'loop_: while ((len)
            <= (*std::cell::LazyCell::force_mut(&mut *&raw mut kMaxHuffmanBits_22)))
        {
            offset[(len)] = sum;
    ...
    if ((offset[(*std::cell::LazyCell::force_mut(&mut *&raw mut kMaxHuffmanBits_22))] as i32)
        == (1))
    {
        code.bits = 0_u8;
...
pub static mut kJpegPrecision_224: std::cell::LazyCell<i32> =
    std::cell::LazyCell::new(|| unsafe { 8 });
pub static mut kBitWriterChunkSize_225: std::cell::LazyCell<usize> =
    std::cell::LazyCell::new(|| unsafe { 16384_usize });
...
pub unsafe fn Reserve_230(mut bw: *mut brunsli_internal_dec_BitWriter, mut n_bytes: usize) {
    if ((((((*bw).pos).wrapping_add(n_bytes))
        > (*std::cell::LazyCell::force_mut(&mut *&raw mut kBitWriterChunkSize_225)))
        as i64)
        != 0)
    {
...
pub unsafe fn BufferEndOfBand_239(
    ...
    if (((*s).refinement_bits_count_)
        > (((32767) * ((*std::cell::LazyCell::force_mut(&mut *&raw mut kDCTBlockSize_3)) - (1)))
            as usize))
    {
        return false;
    }
...
pub unsafe fn BuildHuffmanCodeTable_240(
    ...
    'loop_: while ((l)
        <= ((*std::cell::LazyCell::force_mut(&mut *&raw mut kJpegHuffmanMaxBitLength_7)) as usize))
    {
        let mut i: i32 = (&(*huff)).counts[(l)];
        if (((p) + (i))
            > ((*std::cell::LazyCell::force_mut(&mut *&raw mut kJpegHuffmanAlphabetSize_8)) + (1)))
        {
            return false;
        }
...
pub unsafe fn EncodeSOF_243(
    ...
    (*data.offset((pos.postfix_inc()) as isize)) =
        ((*std::cell::LazyCell::force_mut(&mut *&raw mut kJpegPrecision_224)) as u8);
...
pub unsafe fn EncodeSOS_244(
    ...
    'loop_: while ((i) < (n_scans)) {
        let si: *const brunsli_JPEGComponentScanInfo = &(&(*scan_info)).components[(i)];
...
pub unsafe fn EncodeDHT_245(
    ...
    let huffman_code: *const Vec<brunsli_JPEGHuffmanCode> = &(*jpg).huffman_code;
    let mut marker_len: usize = 2_usize;
    let mut i: usize = ((*state).dht_index as usize);
    'loop_: while ((i) < ((*huffman_code).len())) {
        let huff: *const brunsli_JPEGHuffmanCode = &(&(*huffman_code))[(i)];
        marker_len = (marker_len).wrapping_add(
            ((*std::cell::LazyCell::force_mut(&mut *&raw mut kJpegHuffmanMaxBitLength_7)) as usize),
        );
        let mut j: usize = 0_usize;
    ...
    'loop_: while true {
        ...
        let huff: *const brunsli_JPEGHuffmanCode = &(&(*huffman_code))[(huffman_code_index)];
...
pub unsafe fn EncodeDQT_246(
    ...
    'loop_: while ((i) < ((*jpg).quant.len())) {
        let table: *const brunsli_JPEGQuantTable = &(&(*jpg)).quant[(i)];
        marker_len += ((1)
            + ((if ((*table).precision != 0) { 2 } else { 1 })
                * (*std::cell::LazyCell::force_mut(&mut *&raw mut kDCTBlockSize_3))));
        if (*table).is_last {
            break;
        }
    ...
    'loop_: while true {
        ...
        let table: *const brunsli_JPEGQuantTable = &(&(*jpg)).quant[(idx)];
        (*data.offset((pos.postfix_inc()) as isize)) =
        ...
        {
            let mut val_idx: i32 =
                ((*std::cell::LazyCell::force_mut(&mut *&raw mut kJPEGNaturalOrder_13))[(i)]
                    as i32);
...
pub unsafe fn EncodeRefinementBits_254(
    ...
    let mut k: i32 = Ss;
    'loop_: while ((k) <= (Se)) {
        let abs_val: i16 = (((*coeffs.offset(
            ((*std::cell::LazyCell::force_mut(&mut *&raw mut kJPEGNaturalOrder_13))[(k) as usize])
                as isize,
        )) as i32)
            .abs() as i16);
    ...
    'loop_: while ((k) <= (Se)) {
        ...
        let mut new_non_zero_bit: i32 = if (((*coeffs.offset(
            ((*std::cell::LazyCell::force_mut(&mut *&raw mut kJPEGNaturalOrder_13))[(k) as usize])
                as isize,
        )) as i32)
            < (0))
...
pub unsafe fn DoEncodeScan_255(
    ...
    let scan_info: *const brunsli_JPEGScanInfo =
        &(&(*jpg)).scan_info[((*state).scan_index as usize)];
    let ss: *mut brunsli_internal_dec_EncodeScanState = &mut (*state).scan_state;
    ...
    let base_component: *const brunsli_JPEGComponent =
        &(&(*jpg)).components[((&(*scan_info)).components[(0_usize)].comp_idx as usize)];
    ...
    let has_ac: bool = (complete_ac)
        || (unsafe {
            HasSection_194(
                (parsing_state),
                ((*std::cell::LazyCell::force_mut(&mut *&raw mut kBrunsliACDataTag_37)) as u32),
            )
        });
    if (want_ac) && (!(has_ac)) {
        ...
        'loop_: while ((mcu_x) < (MCUs_per_row)) {
            ...
            'loop_: while ((i) < ((*scan_info).num_components)) {
                ...
                let c: *const brunsli_JPEGComponent =
                    &(&(*jpg)).components[((*si).comp_idx as usize)];
                let dc_huff: *const brunsli_HuffmanCodeTable =
                    &(&mut (*state)).dc_huff_table[((*si).dc_tbl_idx as usize)];
                let ac_huff: *const brunsli_HuffmanCodeTable =
                    &(&mut (*state)).ac_huff_table[((*si).ac_tbl_idx as usize)];
    ...
    (*ss).stage = brunsli_internal_dec_EncodeScanState_Stage_HEAD;
            ...
            __v if __v == (brunsli_internal_dec_SerializationState_Stage_INIT as i32) => {
                {
                    ...
                    {
                        let __a0 =
                            ((*std::cell::LazyCell::force_mut(&mut *&raw mut kMaxHuffmanTables_6))
                                as usize) as usize;
                        (*ss)
                            .dc_huff_table
            ...
            {
                {
                    ...
                    let mut status: brunsli_internal_dec_SerializationStatus = (unsafe {
                        let _marker: u8 = marker;
                        let _parsing_state: *const brunsli_internal_dec_State = &(*state);
...
pub unsafe fn ProcessFile_267(
    ...
    let mut output: Vec<libc::c_char> = vec![0];
    {
        ...
        if ((jpg.version) != (*std::cell::LazyCell::force_mut(&mut *&raw mut kFallbackVersion_2))) {
            {
                input.clear();
                input.push(0)
            };
...
unsafe fn main_0(mut argc: i32, mut argv: *mut *mut libc::c_char) -> i32 {
    ...
    let mut ok: bool = (unsafe { ProcessFile_267(&file_name, &outfile_name) });
...
pub unsafe fn __cpp2rust_init_globals() {
    ...
    std::cell::LazyCell::force(&*&raw const kBitMask_120);
    std::cell::LazyCell::force(&*&raw const kNumDirectCodes_135);
    std::cell::LazyCell::force(&*&raw const kCoeffAlphabetSize_136);
    std::cell::LazyCell::force(&*&raw const kKnownSectionTags_137);
    std::cell::LazyCell::force(&*&raw const kKnownHeaderVarintTags_138);
    std::cell::LazyCell::force(&*&raw const kBufferMaxReadAhead_199);
    std::cell::LazyCell::force(&*&raw const kLengthTree_210);
    std::cell::LazyCell::force(&*&raw const kLogCountTree_211);
    std::cell::LazyCell::force(&*&raw const kCodeLengthCodes_213);
    std::cell::LazyCell::force(&*&raw const kCodeLengthCodeOrder_214);
    std::cell::LazyCell::force(&*&raw const kDefaultCodeLength_215);
    std::cell::LazyCell::force(&*&raw const kCodeLengthRepeatCode_216);
    std::cell::LazyCell::force(&*&raw const kJpegPrecision_224);
    std::cell::LazyCell::force(&*&raw const kBitWriterChunkSize_225);
}
